...
<div class="header">
  ...
  <ul style="list-style-type: none; padding: 0;">
    <li style="display: inline; margin-right: 10px;"><a href="./login.php" style="padding: 10px; color: white; background-color: GREEN; text-decoration: none; margin-right: 15px;">LOGIN</a></li>
    <li style="display: inline; margin-right: 10px;"><a href="./register.php" style="padding: 10px; color: white; background-color:GREEN; text-decoration: none; margin-right: 15px;">REGISTER</a></li>
